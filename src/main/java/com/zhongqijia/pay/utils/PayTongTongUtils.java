...
public class PayTongTongUtils {
    ...
    public static Map<String, String> getWalletInfo(Users users, String tongtongPayRoot){
        try{
    ...
    public static String pay(Users users, String tongtongPayRoot,
    ...
    public static void main(String[] args){
        ...
        pay(users,"C:\\Users\\llg\\qyy\\server\\digital-storage-pay\\src\\main\\resources\\tongtong\\",
